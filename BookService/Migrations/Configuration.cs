    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookService.Models.BookServiceContext>
    {
        ...
        new Author{ AuthorId = 4, Name = "Thurman, Paula" }
            ...
            context.Books.AddOrUpdate(new Book[] {
                  new Book{ BookId = 1,  Title= "Midnight Rain", Genre = "Fantasy", PublishDate = new DateTime(2000, 12, 16), AuthorId = 2, Description = "A former architect battles an evil sorceress.", Price = 14.95M },
